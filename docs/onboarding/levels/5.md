...
> 💡 **Test-Driven Design**: See how the test is the first user of your code? RED is where you design the API; how it _should_ be used before implementing how it works.
