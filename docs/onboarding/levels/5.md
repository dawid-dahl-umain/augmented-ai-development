...
> 💡 **Note**: These tests check exact error message strings for simplicity. In production, you might use error codes or check for key concepts instead of exact wording. This tutorial keeps it simple to focus on the TDD workflow.
