...
| ☝️                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Important**: In `AAID`, planning doesn't involve the AI dreaming up the coming technical implementations.<br><br>**TDD will do that; that's why it's called _Test-Driven_ Development.**<br><br>That's why we use TDD: to let the tests drive the design of our code, instead of wild assumptions. In `AAID`, planning sets the destination, while TDD finds the path. |
