# Acceptance Testing Strategy Roadmap Template

> This roadmap template is part of the AAID BDD/ATDD workflow. If not already loaded, read [SKILL.md](../SKILL.md) first.
...
When the roadmap is complete, present it for user review. Suggest using Claude Code's native plan mode — the roadmap serves as the plan for the upcoming acceptance testing cycle. The user may also choose to save it as a file for future reference.
...
- **Aliasing approach**: Use aliasing utility to give identifiers unique suffixes for each test run
...
- **Aliasing approach**: Use aliasing utility for all customer and product identifiers
- **What gets aliased**:
